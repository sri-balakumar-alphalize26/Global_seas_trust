...
export const en = {
  ...
  about: {
    ...
    heroImageAlt: 'A fisherman casting his nets from a small boat on a calm sea at sunset',
    eyebrow: 'About Us',
    title: 'Our Objective',
  ...
  cards: {
    ...
    tapToCall: 'Choose a number →',
    callChooseTitle: 'Call which number?',
    emailUs: 'Email Us',
...
export const ar: Ui = {
  ...
  about: {
    ...
    heroImageAlt: 'صياد يلقي شباكه من قارب صغير في بحر هادئ عند الغروب',
    eyebrow: 'من نحن',
    title: 'هدفنا',
  ...
  cards: {
    ...
    tapToCall: 'اختر الرقم ←',
    callChooseTitle: 'أي رقم تريد الاتصال به؟',
    emailUs: 'راسلنا',
